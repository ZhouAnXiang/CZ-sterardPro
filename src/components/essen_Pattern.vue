	...
	<div>
		...
		<div class="margins-horizontal-x margins-top-rem  margins-bottom-sm">
			...
			<div class="margins-top-md bg-ddd paddings-x">
				注释： 1.ESSEN评分是评估缺血性卒中患者危险分层并指导用药的理想工具。该评分最初是从CAPRIE研究中提出来，但研究对象为心血管疾病高危人群，后来在REACH研究中验证了该评分在卒中／TIA人群中的应用。 2.对既往卒中／TIA患者，分值越高，患者发生卒中或主要血管事件风险越大；3分是一个界值，高分值患者应强化二级预防治疗
			</div>
			<div class="margins-top-md">
				参考文献： 1.A randomised,blinded,trial of Clopidogrel versus Aspirin in Patients at Risk of Ischaemic Events(CAPRIE).Lancet.1996;348:1329-1339. 2.The essen stroke risk score predicts recurrent cardiovascular events:A validation within the reduction of atherothrombosis for continued health(REACH) registry.Stroke.2009;40:350-354.
			</div>
		</div>
	</div>
</template>
